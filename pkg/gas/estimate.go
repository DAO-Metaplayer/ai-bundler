...
import (
	...
	"github.com/DAO-Metaplayer/ai-bundler/pkg/aimiddleware/execution"
...
// EstimateGas uses the simulateHandleOp method on the AiMiddleware to derive an estimate for
...
func EstimateGas(in *EstimateInput) (verificationGas uint64, callGas uint64, err error) {
	...
	// this case, consider calling the EstimateGas function after setting the gas price on the AiOperation.
	l := int64(0)
