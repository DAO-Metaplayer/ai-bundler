...
// AiOperations to the AiMiddleware. It returns the larger value between the suggested gas tip or the average
...
// SuggestMeanGasFeeCap suggests a Max Fee for an EIP-1559 transaction to submit a batch of AiOperations to
// the AiMiddleware. It returns the larger value between the recommended max fee or the average maxFeePerGas of
// the entire batch.
...
// SuggestMeanGasPrice suggests a Gas Price for a legacy transaction to submit a batch of AiOperations to
// the AiMiddleware. It returns the larger value between a given gas price or the average maxFeePerGas of the
// entire batch.
